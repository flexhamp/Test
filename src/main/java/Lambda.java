...
//        birthDate1.setValue(df.parse("22-03-18"));
        ...
        individualName5.setFirstName("Test1");
        individualName5.setLastName("Testov1");
        individualName5.setSecondName("Test1");
        ...
        System.out.println(collectionsComparator("").compare(Arrays.asList(individual1), list));
//        System.out.println(dateComparator().compare(individual3, individual2));
    }


    public static <T> Comparator<Collection<Individual>> collectionsComparator(String elemComparator) {
        return (col1, col2) -> {
            TreeSet<Individual> treeSet = new TreeSet<>(individualComparator());
            treeSet.addAll(col1);
    ...
    private static Comparator<Individual> individualComparator() {
    ...
    private static <T, R extends Comparable> Comparator<T> uniComparator(Function<T, R>... thenComparing) {
